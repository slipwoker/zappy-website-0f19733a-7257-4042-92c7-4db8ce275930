...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      var e=document.querySelectorAll('a[href^="tel:"]');var n=e.length>0?e[0].getAttribute("href").replace("tel:",""):"048221739";window.location.href="tel:"+n
    });
  }
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '0f19733a-7257-4042-92c7-4db8ce275930',
                name: data.name || '',
                email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0f19733a-7257-4042-92c7-4db8ce275930';
